# Non-Authoritative Donor/Library Module-Effect Sensitivity Summary

Generated by `scripts/summarize_donor_module_effects.py`.

## Result contract

This is a custom descriptive sensitivity/audit summary. It must not be substituted for data/derived/donor_module_effect_summary/.
...
- Available cohort/compartment/module effects: 8
